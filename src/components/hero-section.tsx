      ...
      >
        <div className="grid items-start lg:items-center gap-10 lg:gap-12 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,1fr)]">
          {/* COLUNA ESQUERDA – Conteúdo */}
              <div className="relative max-w-2xl text-center lg:text-left mx-auto lg:mx-0">

                {/* LOGO DE FUNDO GIGANTE, CENTRALIZADO */}
                <div
                  aria-hidden="true"
                  className="
                    pointer-events-none
                  ...
                  "
                >
                  <div className="relative w-[420px] h-[420px] sm:w-[520px] sm:h-[520px] md:w-[600px] md:h-[600px]">
                    <Image
                ...
                >
                  {benefits.map((item) => (
                    <li key={item} className="flex items-start gap-2 text-left">
                      <CheckCircle2 className="mt-[2px] h-5 w-5 flex-shrink-0 text-[var(--accent-orange)]" />
                      <span>{item}</span>
                    </li>
                  ))}
                </motion.ul>
